...
Refinery::Core.configure do |config|
  ...
  config.s3_backend = !(ENV['AWS_ACCESS_KEY_ID'].nil? || ENV['AWS_SECRET_ACCESS_KEY'].nil?)
  ...
  # Site name
  config.site_name = "La fogaina"

  # This activates Google Analytics tracking within your website. If this
  # config is left blank or set to UA-xxxxxx-x then no remote calls to
  # Google Analytics are made.
  config.google_analytics_page_code = "UA-83984706-1"
  ...
  # config.dragonfly_secret = "500a890ca31da1390d4d9666e4b373ec98eda5c0ba3a54c8"
