...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "9745930d131da697e0b15bbca624196442558ea32805efb0"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/home/chillout/development/rails/fogaina/public/system/refinery/resources"
