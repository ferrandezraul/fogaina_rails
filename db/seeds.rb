...
Normalment les places pels cursos son màxim de 7 persones, per poder gaudir de l'espai i de l'aprenentatge. Tots el cursos es poden pagar amb moneda social.</p>
                ...
                },
                {
                    ...
                    :title_es => "Media",
                    :title_ca => "Media",
                    :body => "This is the body of Media.",
                    :body_es => "Esto es el body de Media.",
                    :body_ca => "Això es el body de Media",
                    :side_body => "This is the side body of Media.", 
                    :side_body_es => "Esto es el side body de Media.",
                    :side_body_ca => "Això es el side body de Media", 
                },
                {
                    :show_in_menu => true,
                    :deletable => true,
