...
                              <p> Recuerdo con una sonrisa en los primeros días que empecé a indagar en este mundo panarra, sobre todo vía internet, visitando foros, webs y vídeos; alucinaba con la cantidad de técnicas y métodos que existían, que no podía evitar probar, y convertía la cocina de su casa a cualquier hora del día o de la noche en el laboratorio de un alquimista loco. Fue cuando hice nuestra primera masa madre natural, que todavía hoy nos acompaña cada día en el trabajo.
                              No negaré que el salto de panadero casero profesional fue una locura, un gran paso donde hay demasiados aspectos que no controlas y no los ves venir hasta que te los encuentras de golpe. No vengo de una familia de panaderos, ni he estudiado en la escuela de panaderos Lo que realmente necesitaba, como poder formarme en el extranjero donde sí consideraba que había buen pan y buenas escuelas, ya se me hacía muy difícil: arrastrar a toda la familia en Francia, o Alemania, sin idioma, sin dinero, a estudiar en escuelas normalmente bastante caras ...
                              Así que casi no nos quedó más remedio que tirar a ella de cabeza ... sin saber nadar, sin flotador ni brazaletes ... casi nos ahogamos. Es un oficio duro y el camino elegido no es el más fácil, pero nos mantenemos a flote, y las aguas ya más tranquilas.
                              Suerte de la cantidad de gente que por el camino nos ha ayudado, de muchas maneras, sin ellos no lo habríamos conseguido. Suena tópico, pero es cierto. </p>
...
                              <p> Estamos muy orgullosos de lo que hemos logrado hasta ahora, trabajamos duro y tenemos un producto honesto y saludable. La Fogaina es una suma de los que la formamos, por lo que es más viva que nunca. Parece claro que, como hace cada día nuestra masa madre, continuaremos creciendo, con nuevas ideas y aún más sorpresas.
                              Esperamos que disfrutéis de nuestros productos, de nuestro espacio y de nuestro trato ... </p>",
